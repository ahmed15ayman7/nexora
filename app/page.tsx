...
import {
  DeviceLaptopExecutive,
  DeviceLaptopOperations,
  DevicePhoneMenu,
  DevicePhoneOrderLookup,
  EcoArrow,
  featureMocks,
...
const heroChips = [
  "عرض المنيو على الموبايل",
  "متابعة الطلبات بالجوال",
  "محتوى ومراجعة الطلبات",
  "إدارة عامة وتقارير",
] as const;
...
const ecosystem = [
  {
    step: "١",
    eyebrow: "عرض المنيو على الموبايل",
    title: "قائمة واضحة من غير ما تختلط بمسار العربة",
    role: "أول نقطة بتقابل عميلكم — اطّلاع على المنيو والأسعار.",
    body:
      "الشاشة مخصّصة للقراءة: عنوان «عرض المنيو»، وبطاقات أصناف فيها مصغّر وخطّين زي الاسم والوصف القصير. السطر دهبي في الأسفل بيفصل الفكرة إن تأكيد الطلب وحالة الدفع ممكن يتفتحوا في وحدة تجزئة تانية لو أنتوا قسّمتو تجربة الطلب بالشكل ده.",
    bullets: [
      "شريط رفيع تحت عدسة الكاميرا بيحافظ على شكل الهاتف الحقيقي؛ فوقوا عليه عنوان الصفحة عشان يبان إن المرحلة دي موبايل أولًا.",
      "ثلاث بطاقات متكرّرة بتقلِّل التشتيت: كل صف له حدود ذهبية واضحة وفيه خطوط نص فاتحة كإسم ومعلومتين.",
      "مستطيل شفّاف قبل الحواشي السفلية بينوِّه إن عرض الأسعار والأصناف منفصل عن ضغطة «التأكيد» اللي ممكن تنقل للعربة خارج القسم ده.",
    ],
    mockNote:
      "البنية تسمح بعرض منيو موسمية تُدار من لوحة المحتوى من غير ما عيلة الأسعار تقفل جوّة واجهة العميل بس.",
    node: DevicePhoneMenu,
  },
  {
    step: "٢",
    eyebrow: "متابعة الطلبات بالجوال نفسه",
    title: "يُبحث بطلب برقم الجوّال بتاع الطلب الأصلي",
    role: "نفس عميلكم… ولكن بتطابق الهوية قبل ما يطلع السجل.",
    body:
      "العميل يفتح «طلباتي»، يكتب الرقم اللي سبق وأدّاه وقت إنشاء الطلب، وبعدين يضغط «بحث عن الطلبات». النتيجة بتيجي أسطر متجاورة كل سطر له حالة ومؤشِّر بحيث يبيِّن إذا الطلب متحرّك ولا لا من غير ما يحتاج تطبيق تالت.",
    bullets: [
      "عنوان «طلباتي» فوق بتثبيت المرحلة: دي مش شاشة عربة ولا منيو؛ دي تستعلم عن أوامر سابقة.",
      "المستطيل اللي فيه نقاط بتذكّر إن الموضوع بحث بحقل جوّال، مش كود سري خارجي؛ نفس المعيار بتاعكم اللي بتسجلوا بيه أول أوردر.",
      "البطاقات اللي ورا بتيجي عمود واحد وفيه دوائر دهبية جانبية بتقدّر انتربريتيهالها كرمز الحالة وقت ما تكمِّنون ربيتها بتفاصيل المطبخ أو التوصيل.",
    ],
    mockNote:
      "الخط السفلي بيفسِّر إن أي خرائط أو ETA تقدر تتلاقى برّه الرسم ومش بتخنق منيو العميل نفسها.",
    node: DevicePhoneOrderLookup,
  },
  {
    step: "٣",
    eyebrow: "لوحة تشغيل مزدوجة للمطعم",
    title: "منيوّك ومراجعة طلباتك في المتصفّح نفسه",
    role: "فريق تشغيل يركز على المحتوى والعمليات معًا.",
    body:
      "اللابتوب هنا مش شاشة «حسابات وحدة»؛ يسار شريط «محتوى» فيه منيو وعروض، ووسط عمود لتعديل سطور المنتجات، ويمين جدول «الطلبات» بأسطر فاصلة بصريًا. الفكرة إن من يمسك المحتوى يقدر يراجع الأوردرات من غير ما يقفّل سيشن تاني لو صلاحياتكم سمحت بذلك.",
    bullets: [
      "الخطوط المتدرجة في عمود المحتوى بتدي إحساس إنهم أقسام متعددة بتتقلِّب بين عروض ومنيو دون تنقل صفحة.",
      "شبكة الخلفية في عمود المنيو توضّح إن ده مساحة لسطور تفاصيل وفترات الأسعار حيث تكمِّنونها.",
      "خطوط الجدول في عمود «الطلبات» بتتكرر عشان تدي إحساس بتابل يمكن يتوسّط صليات مطبخ أو حالات مختلفة وفق واقعكم.",
    ],
    mockNote:
      "هيك ملائم لفريق واحد بينضبّط وقت الذروّة بحيث المنيو متحدَّث قبل ما الأوردرات تكتر.",
    node: DeviceLaptopOperations,
  },
  {
    step: "٤",
    eyebrow: "إدارة عامة وقياس أداء",
    title: "تقارير وصلاحيات تغطّي كل أجزاء الموقع",
    role: "القرارات الاستراتيجية ومَن له حق التعديل الكامل.",
    body:
      "واجهة «إدارة عامة» تجمع دائرة تقدّم، أعمدة إحصاء، وحواشٍ تشرح إن هنا تُضبط صلاحية «أدمن عام» يقدر يضيف أو يعدّل أي عنصر في الموقع. الأرقام في الرسم رمزاً بصرياً؛ بتربطوها بتقارير حقيقية وفق تنظيم بياناتكم.",
    bullets: [
      "القطاع الدائري يصلح لتتبّع معدلات الطلبات أو أهداف يومية حسب ضبط المؤشِّر عندكم.",
      "سلّم الأعمدة يدعم مقارنة فترات متجاورة زي المواسم أو أيام الأسابيع الثقيلة.",
      "السطر الأخير يحمي المنتج: يوضّح إن كل صلاحية شاملة لازم تناسب سياساتكم قبل ما تنزل للمجموعات الحسّاسة في التشغيل.",
    ],
    mockNote:
      "الشكل هنا لتسليم الموضوع لصاحب القرار، مش لموظّف واحد وسط الصالة وقت الذروّة لوحدها.",
      ...
      <header className="relative z-[1] flex flex-col items-center px-5 pb-16 pt-[max(6.5vh,2.5rem)] text-center sm:px-6 md:pb-[4.5rem]">
        ...
        <div className="relative inline-flex max-w-[36rem] flex-col items-center gap-4">
          ...
          <p className="relative mt-2 max-w-[32rem] text-[0.945rem] leading-[1.95] text-zinc-300/92 sm:text-[0.975rem]">
            منصّة واحدة تجمع عرض المنيو على الموبايل، ومتابعة الطلبات بحثًا برقم الجوال، ثم لوحة لتعديل المحتوى ومراجعته مع الطلبات، وأخيرًا إدارة عامة بتقارير وصلاحيات شاملة —
      ...
      <main className="relative z-[1] mx-auto flex w-full max-w-[1140px] flex-1 flex-col gap-[4.25rem] px-5 pb-[min(28vh,6.9125rem)] pt-5 sm:gap-[5rem] md:gap-[5.5rem] lg:px-8">
        <section aria-labelledby="nexora-loop">
          <div className="mb-11 flex flex-col items-center gap-4 text-center sm:mb-[3.0625rem] sm:gap-5">
            <SectionEyebrow>مسار الخدمة على أربع مراحل</SectionEyebrow>
            <h2
              id="nexora-loop"
              className="text-balance text-[1.72rem] font-semibold tracking-wide text-neutral-50 sm:text-[clamp(1.62rem,_3.25vw,_1.92rem)]"
              style={{ fontFamily: "var(--font-display), serif" }}
            >
              من عرض المنيو إلى الإدارة العامة
            </h2>
            <p className="mx-auto max-w-[36rem] text-[0.9525rem] leading-[1.92] text-zinc-300/93 sm:text-[0.9825rem] md:leading-[1.965]">
              العرض المتسلسل ده بيجسّد رحلة العميل والتشغيل: اطّلاع على القائمة، متابعة الطلبات بنفس رقم الجوال، ثم لوحة لتحرير المحتوى ومراجعة الطلبات، ثم شاشة إشراف تضمّ التقارير والصلاحيات الشاملة.
            </p>
          </div>
          ...
          <div className="mx-auto flex w-full max-w-[90vw] flex-col md:max-w-[90vw]" lang="ar">
            {ecosystem.map((pane, idx) => {
              ...
              const isPhone =
                PaneIcon === DevicePhoneMenu ||
                PaneIcon === DevicePhoneOrderLookup;
              return (
        ...
        <section aria-labelledby="feature-grid" className="space-y-14 md:space-y-16">
          <div className="flex flex-col items-center gap-[1.0625rem] text-center sm:gap-[1.25rem]">
            ...
            <p className="mx-auto max-w-[38rem] px-1 leading-[1.95] text-zinc-300/93 md:text-[0.985rem] md:leading-[1.9825rem]">
              توزيع مختصر للمنيو المعروضة للعميل، ومتابعة الطلبات بحثًا بالجوال، ولوحة مزدوجة للمحتوى والأوردرات، ثم إدارة عامة بالتقارير والصلاحيات الكاملة.
            </p>
          </div>
