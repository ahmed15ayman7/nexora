...
const ecosystem = [
  {
    ...
    body:
      "الشاشة مركّزة على المنيو: عنوان قصير «منيو»، وبطاقات أصناف فيها مصغّر وخطّين بدل شرح طويل. تأكيد الطلب أو العربة بتتكمِّن تبقى في جزء آخر من الموقع لو قسّمتو الرحلة؛ الرسم السفلي عبارة عن شريط مرجعي وليس زرًا نصّيًا مملوءًا.",
    bullets: [
      "شريط رفيع تحت عدسة الكاميرا؛ فوق عنوان «منيو» بخط أكبر وبطاقات أوضح بحدود ذهبيّة وحشو داكن للصور المصغّرة.",
      "ثلاث بطاقات؛ كل وحدة فيها مصغّر وفيه خطّين لوصف مختصر بدل أسطر نص جوّه الهاتف نفسها.",
      "في الأسفل شريط ذهبي نحيف كمرجع واجهة موبايل حديث — مش زر عنوان طويل داخل اللوحة.",
    ],
    mockNote:
  ...
  },
  {
    ...
    body:
      "العميل يفتح «طلباتي»؛ حقل واحد لمعلومات الطلب ورقم يظهر كخط فاتح داخل مستطيل، ثم ضغطة «بحث». النتيجة أسطر عمودية ودوائر حالة بدل أسطر تشريح داخل تصميم الأيقونة.",
    bullets: [
      "المستطيل العلوي بيمثِّل مساحة الإدخال برقم الجوّال من غير تكديس شرح؛ الخط الداخلي دليل أن فيه محتوى مكتوب.",
      "زر «بحث» كبيرة ووسط الصفحة — أقصر من زر عنوان طويل عشان تفضل مقروء لو الرسم تصغّر.",
      "أسطر النتيجة بتيجي وفيه دوائر جانبية تقدِّر تربيطها بحالة مختصرة لما تكمِّنون منطق المنتج اللي ورا المنيو للعميل.",
    ],
    mockNote:
      "الشريط السفلي نفس دليل المنيو الأول — دلالة تفاعل جزئية من غير سرد حالة الطلب أو خرائط داخل الرمز.",
  ...
  },
  {
    ...
    body:
      "ثلاث قطاعات عمودية مفصولين بخطوط رفيعة: جهة رسوم قائمة جانبية، ووسط أسطر قائمة منتج، ويمين شبكة أسطر تشبه جدول الطلبات. عنوان وحيد «لوحة التشغيل» فوق — تفاصيل الأقسام نسميها برّه الشاشة في الشرح وليس كل عمود وحده جوّة الرسم.",
    bullets: [
      "خطوط ذهبيّة تفصل القطاعات الثلاثة عشان تبان التقسييم حتى بدون اسم على كل عمود.",
      "وسط القائمة فيه أسطر بتتوسّع تدريجيًا — كأنها صف منتج وبعدين سعر أو فاصل.",
      "الشبكة اليمنى بتكرار أسطر موازية يعطيك إحساس جدول طلبات واسع للمراجعة.",
    ],
    mockNote:
  ...
  },
  {
    ...
    body:
      "لوحة عنوانها «إدارة عامة» فقط؛ على اليسار دائرة جزئية بمركز واضح، ويمينها أعمدة متدرّجة وحلقة مؤشر. التفسير الطويل لصلاحيات «أدمن عام» بتقدّره في الوثائق، مش كنص ضيق داخل المخطّط القطاعي الخاص بالرسم.",
    bullets: [
      ...
      "في الجانب حلقة خفيفة وخطّان ملخِّصَين — دلالة على أكثر من KPI من غير تكديس وسط الواجهة.",
    ],
    mockNote:
